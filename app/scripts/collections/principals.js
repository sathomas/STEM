...
// Backbone collection for a set of group or user objects from
// the Open Academic Environment.
//
// Unlike typical Backbone collections, the Principals collection
...
//
//     var content = new Stem.Collections.Principals([], options);
//
...
(function () {
    ...
    Stem.Collections.Principals = Backbone.Collection.extend({

        model: Stem.Models.Principal,
        ...
        url: function() {
            ...
            return Stem.config.oae.protocol + '//' + Stem.config.oae.host +
                '/api/search/general?resourceTypes=group&resourceTypes=user&scope=_tenant' +
